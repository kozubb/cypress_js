export default class LoginPage {
	...
	// Check existing of login error message
	validateIfLoginErrorMessageExist(exist = true) {
		const expectation = exist ? 'exist' : 'not.exist'

		cy.get('[data-test="error"]').should(expectation)
	}
